              ...
              <div class="right-side p-4">
                  ...
                  <div class="ads-list-area">
                      ...
                      <div class="row mb-4 pb-4">
                          ...
                          <div class="col-md-2">
                            <img src="<?php echo $this->Url->build('/gear_img/'.$gear->upload); ?>" alt="" class="img-fluid">
                          </div>
                          ...
                          <div class="col-md-2">
                              ...
                              <?php if($gear->user_id == $user->id) { ?>                        
                               <a href="<?php echo $this->Url->build(["controller" => "Gears","action" => "editgear", $gear->id]);?>" class="btn btn-sm btn-secondary">Edit</a>
                               
                                <a href="<?php echo $this->Url->build(["controller" => "Gears","action" => "geardelete", $gear->id]);?>" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-sm btn-danger">Delete</a>
                                <?php } ?>
                          </div>
                      </div>
                      <?php
