                            ...
                            <ul class="nav">
                                <li style="margin-right:15px">
                                    <div class="btn-group" style=" margin-top: 8px">
                                        <a href="<?php echo $this->Url->build(["action" => "add"]); ?>"> <button class="btn btn-info btn-xs"><i class="icon-cogs icon-white"></i> Add Colour</button>  </a>
                                    </div>
                                </li>
                            </ul>
        ...
        foreach ($colour as $dt):
            ...
            <tr>
                ...
                <td class="actions">                                                           
                    ...
                    <?php if ($dt->status == 1) { ?><a href="<?php echo $this->Url->build(["action" => "chstatus", $dt->id, 0]); ?>"> <button class="btn btn-success btn-xs"><i class="icon-thumbs-down"></i> Active</button> </a>
                    <?php } else if ($dt->is_active == 0) { ?><a href="<?php echo $this->Url->build(["action" => "chstatus", $dt->id, 1]); ?>"> <button class="btn btn-info btn-xs"><i class="icon-thumbs-up"></i> InActive</button> </a>
                    <?php } ?>
