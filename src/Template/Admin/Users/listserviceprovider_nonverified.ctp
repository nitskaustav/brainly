...
<div id="content">
    <div class="inner">
        <div class="row">
            <div class="col-lg-12">
                <h1> Non-Verified Seller List </h1>
            </div>
        </div>
        <hr />
        <div class="row">
            <div class="col-lg-12">
                <div class="box">
                    <header>
                        ...
                        <h5> Non-Verified Clients List</h5>
                        <div class="toolbar">
                            <ul class="nav">
                                <li style="margin-right:15px">
                                    <div class="btn-group" style=" margin-top: 8px">
                                        <a href="<?php echo $this->Url->build(["action" => "addserviceprovider"]); ?>"> <button class="btn btn-info btn-xs"><i class="icon-cogs icon-white"></i> Add Seller </button>  </a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="accordion-body collapse in body">
                        <div class="col-sm-12">
                            ...
                            <div><h4><b>Total non verified Clients: <?php echo $countprovider; ?></b></h4></div>
                        </div>
                    </div>
                                            ...
                                            <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo $this->Paginator->sort('Seller name') ?></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($user as $doct):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo h($doct->first_name) ?> <?php echo h($doct->last_name) ?></td>
                                                            ...
                                                            <td class="actions">
                                                                ...
                                                                <?php /* if ($doct->is_active == 1) { ?>
                                                                  <a href="<?php echo $this->Url->build(["action" => "companystatus_nonverified", $doct->id, '0']); ?>"> <button class="btn btn-info btn-xs"><i class="icon-thumbs-down"></i> Suspend</button> </a>
                                                                  <?php } else if ($doct->is_active == 0) { ?>
                                                                  <a href="<?php echo $this->Url->build(["action" => "companystatus_nonverified", $doct->id, '1']); ?>"> <button class="btn btn-success btn-xs"><i class="icon-thumbs-up"></i> Active</button> </a>
                                                                  <?php } */ ?>

                    <!--                                                         <a href="<?php echo $this->Url->build(["action" => "listservice", $doct->id]); ?>" > <button class="btn btn-success btn-xs"><i class="icon-plus icon-white"></i> Services</button> </a>  -->
