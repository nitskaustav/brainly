...
<table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
    <thead>
        <tr>
            ...
            <th><?php echo $this->Paginator->sort('user type') ?></th>
    ...
    <tbody>
        ...
        foreach ($user as $doct):
            ...
            if($doct->utype == 1){
                ...
                $assignteamlead = '<a href="<?php echo $this->Url->build(["action" => "userview", $doct->id]); ?>"> <button class="btn-btn-info btn-xs">Assign Tead Lead</button></a>';
            }
            elseif($doct->utype == 2){
                $usertype = "Team Lead";
                $assignteamlead = '';
            ...
            <tr>
                ...
                <td><?php echo ($doct->first_name)." ". ($doct->last_name) ?></td>
...
<?php } ?> 
                <td class="actions">
                    ...
                    <?php } ?>
                    <?php if($doct->utype == 1){ ?>
                    <a href="<?php echo $this->Url->build(["action" => "assigntl", $doct->id, 2]); ?>"> <button class="btn-btn-info btn-xs">Assign TL</button> </a>
                    <?php }elseif($doct->utype == 2){ ?>
                    <a href="<?php echo $this->Url->build(["action" => "assigntl", $doct->id, 1]); ?>"> <button class="btn-btn-info btn-xs">Unassign TL</button> </a>
                    <?php } ?>
                </td>                
            </tr>
            <?php $i++;
