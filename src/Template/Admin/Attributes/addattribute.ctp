                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <?php
                                            foreach($brands as $brand_val){ ?>
                                                <input type="checkbox" name="brand_ids[]" value="<?php echo $brand_val->id; ?>"><?php echo $brand_val->brand_name; ?><br>
                                    ...
                                    <div class="col-lg-8">
                                        <?php
                                            foreach($sizes as $sizes_val){ ?>
                                                <input type="checkbox" name="size_ids[]" value="<?php echo $sizes_val->id; ?>"><?php echo $sizes_val->size; ?><br>
                                ...
                                <div class="col-lg-8" style="text-align:left;"> 
                                    <input type="submit" name="submit" value="Add Attribute" class="btn btn-primary" />
                                </div>
                                </form>
                            </div>
                        </div>
