                                                ...
                                                <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo $this->Paginator->sort('booked date') ?></th>
                                                            <!--<th><?php echo $this->Paginator->sort('Booked time') ?></th>-->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($service as $dt):
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo h($dt->booking_date) ?></td>
                                                               <!-- <td><?php echo h($dt->booking_time) ?></td>-->

                                                                <?php if ($dt->status == 1) { ?>
                                                                    <td style="color: green"><?php echo h('Active') ?></td>
                                                                <?php } else if ($dt->is_active == 0) { ?>
                                                                    <td style="color: red"><?php echo h('Completed') ?></td>
                                                                <?php } ?> 
                                   <!--<td class="actions">
