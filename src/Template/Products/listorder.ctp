                  ...
                  <div class="ads-list-area">
                      ...
                      <div class="row mb-4 pb-4">
                          ...
                          <div class="col-md-8 my-md-0 my-3">
                          	  <p class="mb-0">Order Date: <b><?php echo $order_data->order_date;?></b></p>

                              <p  class="mb-0">Order Status:<b><?php echo $order_data->order_status; ?></b>
                                
                              </p>
                                                     
                              <p class="mb-0">Payment Mode: <b><?php echo $order_data->payment_mode;?></b></p>

                              
                          </div>
                          <div class="col-md-2">
                              <h5>Price : <b class="text-primary">$<?php echo $order_data->total_price;?></b></h5>                        
                               <a href="<?php echo $this->Url->build(["controller" => "Products","action" => "listorderdetails", $order_data->id]);?>" class="btn btn-primary btn-block">Details</a>
