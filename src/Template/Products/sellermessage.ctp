              ...
              <div class="right-side p-4">
                  ...
                  <div class="ads-list-area">
                      ...
                      <div class="row mb-4 pb-4">
                          ...
                          <div class="col-md-8 my-md-0 my-3">
                              <p class="mb-0"><b>Name:</b> <?php echo $request->name;?></p>
                          </div>
                          <div class="col-md-8 my-md-0 my-3">
                              <p class="mb-0"><b>Email:</b> <?php echo $request->email;?></p>
                          </div>
                          <div class="col-md-8 my-md-0 my-3">
                              <p class="mb-0"><b>Phone:</b> <?php echo $request->phone;?></p>
                          </div>
                          <div  class="col-md-8 my-md-0 my-3">
                              <p class="mb-0"><b>Message:</b> <?php echo $request->message;?></p>
                          </div>
                          <div  class="col-md-8 my-md-0 my-3">
                              <p class="mb-0"><b>Bike Registration Number:</b><a href="<?php echo $this->Url->build(["controller" => "Products","action" => "details", $request->product->id]);?>" style="text-decoration: none;"><?php echo $request->product->reg_number;?></a></p>
                          </div>
                      </div>
                      <?php
                        }
