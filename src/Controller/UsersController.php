...
// echo json_encode($data);exit;
    ...
    public function signup() {
        ...
        if ($this->request->is('post')) {
            ...
            $this->Flash->error(__('Username can not be empty. Please, try again.'));
            $flag = false;
            }
            ...
            if ($this->request->data['day'] == "") {
                $this->Flash->error(__('Day can not be empty. Please, try again.'));
                $flag = false;
            }
            $day = trim($this->request->data['day']);
            $this->request->data['day'] = $day;

            if ($this->request->data['month'] == "") {
                $this->Flash->error(__('Month can not be empty. Please, try again.'));
                $flag = false;
            }
            $month = trim($this->request->data['month']);
            $this->request->data['month'] = $month;

            if ($this->request->data['birth_year'] == "") {
                $this->Flash->error(__('Birth year can not be empty. Please, try again.'));
                $flag = false;
            }
            $birth_year = trim($this->request->data['birth_year']);
            $this->request->data['birth_year'] = $birth_year;
            ...
            if ($flag) {
                ...
                $fullname = trim($this->request->data['username']);
                ...
                if ($rs = $this->Users->save($user)) {
                    ...
                    $email = new Email('default');
                    $email->emailFormat('html')->from([$mailFrom => $mailFromSub])
                            ->to($mail_To)
                            ->subject($mail_subject)
                            ->send($mail_body);
