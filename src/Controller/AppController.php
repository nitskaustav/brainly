...
class AppController extends Controller {
    ...
    public function beforeRender(Event $event) {
        ...
        $this->set(compact('user_details', 'interesrname', 'appCurController', 'SiteSettings', 'appCurActiion', 'appSlider', 'totReview', 'appReviews', 'appReviewsDt', 'revCount', 'appNews', 'provider_avg_review', 'user_id'));
    }
